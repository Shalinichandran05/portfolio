// All portfolio copy lives here - edit this file to update text without touching components.
...
export const hireRoadmap = [
  'You hire Shalini',
  'Learns the codebase quickly',
  'Asks questions and understands requirements',
  "Adapts to the team's workflow",
  'Collaborates effectively with teammates',
  'Solves problems with curiosity and persistence',
  'Focuses on both functionality and user experience',
  'Keeps improving through feedback and learning',
  'Becomes a reliable contributor to the team',
]

export const technicalSkills = [
  'Java', 'Python', 'JavaScript', 'React', 'Node.js', 'Express',
...
export const teammateNotes = [
  {
    title: 'I ask before I assume',
    body: "If something is unclear, I'd rather ask a quick question than guess and redo the work later.",
  },
  {
    title: 'I show up for the boring parts too',
    body: 'Documentation, code review, the small fixes nobody wants - I take those seriously, not just the exciting features.',
  },
  {
    title: 'I learn out loud',
    body: "When I don't know something, I say so, and then I go figure it out. I'd rather grow visibly than pretend.",
  },
  {
    title: 'I care how it feels to use, not just how it works',
    body: "A feature isn't done when it functions - it's done when it feels right to the person using it.",
  },
]

export const memories = [
  { title: 'First Java Program', note: 'The first "Hello World" that actually compiled. Took longer than it should have.', image: '/images/memories/first-java.png' },
...
export const storyNodes = [
  { id: 'hero', label: 'Meet Shalu' },
  { id: 'skills', label: "Skills I'm Building" },
  { id: 'projects', label: "Things I've Built" },
  { id: 'experience', label: 'Real World Experience' },
